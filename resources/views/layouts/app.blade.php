                        ...
                        <div class="navbar-header">
                            <!-- Navbar Header--><a href="/" class="navbar-brand">
                                ...
                                <div class="brand-text brand-sm"><strong
                                        class="text-primary">L</strong><strong>C</strong></div>
                            </a>
                            <!-- Sidebar Toggle Btn-->
            ...
            <div style="padding-top:81px" class="d-flex align-items-stretch">
                ...
                <nav id="sidebar">
                    ...
                    <div class="sidebar-header d-flex align-items-center">
                        <div class="avatar"><img src="/core/img/LOGO LIST 2.png" alt="..." class="img-fluid rounded-circle">
                        </div>
                        <div class="title">
                            <h1 class="h5">LC</h1>
                            <p>(listcreative.id)</p>
                ...
                <div class="page-content">
                    ...
                    <div class="page-header no-margin-bottom">
                        <div class="container-fluid">
                            <h2 class="h5 no-margin-bottom">Web Apps Accounting Managements</h2>
                        </div>
                    </div>
                    <!-- Breadcrumb-->
                    <div class="container-fluid">
                    ...
                    <footer class="footer">
                        <div class="footer__block block no-margin-bottom">
                            <div class="container-fluid text-center">
                                ...
                                <p class="no-margin-bottom">2023&copy; Web Page Design by <a
                                        href="https://github.com/mushlihun">Mushlihun
