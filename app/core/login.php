          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="info d-flex align-items-center">
                <div class="content">
                  <div class="logo">
<h1>Web Apps Accounting Managment</h1>                  </div>
      ...
      <div class="copyrights text-center">
        <p>Design by <a href="https://github.com/mushlihun/" class="external">Mushlihun - Web</a></p>
        <!-- Please do not remove the backlink to us unless you support further theme's development at https://github.com/mushlihun/donate. It is part of the license conditions. Thank you for understanding :)-->
      </div>
    </div>
    <!-- JavaScript files-->
